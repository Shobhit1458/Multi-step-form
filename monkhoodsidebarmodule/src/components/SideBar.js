...
const SideBar = () => {
  ...
  return (
    ...
    >
      ...
      <div
        id="sidebar"
        class=" hidden bg-white h-screen md:block shadow-xl px-3 w-30 md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out"
        x-show="sidenav"
      >
        <div class="space-y-6 md:space-y-10 mt-10">
          ...
          <div id="profile" class="space-y-3">
            ...
            <div>
              ...
              <p class="text-xs text-gray-500 text-center">Filter it from Here!</p>
            </div>
          </div>
          <div
